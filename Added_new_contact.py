...
class Added_new_contact(unittest.TestCase):
    def setUp(self):
        self.wd = WebDriver(capabilities={"marionette": False})
        self.wd.implicitly_wait(60)
    
    def test_Added_new_contact(self):
        success = True
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.new_contact(wd, Contact(firstname="Brad", middlename="BP", lastname="Pitt", nickname="Braddy", photo="C:\\12.jpg", title="Junior", company="21 Fox", address="Hollywood", homenumber="123456789",
    ...
    def test_Added_new_empty_contact(self):
        success = True
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.new_contact(wd, Contact(firstname="", middlename="", lastname="", nickname="", photo="",
                         title="", company="", address="", homenumber="",
                         mobile="", worknumber="", fax="", website="",
                         email="", byear="", ayear="",
